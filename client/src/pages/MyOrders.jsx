...
const MyOrders = () => {
  ...
  item.product && item.product.image ? ( // 🛡️ Check if product and image exist
    ...
    <div key={index} className="relative bg-white text-gray-500/70 border-b border-gray-300 p-4 py-5">
